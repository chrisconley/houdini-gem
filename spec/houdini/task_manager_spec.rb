...
describe Houdini::TaskManager do
  describe ".register, .submit!, and .process" do
    ...
    it "should save it and let us call it again, when we give the right blueprint and class" do
      ...
      task.should_receive(:process).with(42, houdini_output).and_return(processing_result)
      Houdini::TaskManager.process('MyClass', 42, 'blueprint_name', houdini_output).should == processing_result
    end
  end
end
